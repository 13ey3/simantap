    ...
    <div class="card-body">
        ...
        <div class="row mb-1">
            ...
            <div class="col-sm-3 ml-auto">
                <input type="text" placeholder="Cari " class="form-control form-control-sm float-right" name="kolomcari" id="kolomCariPermohonanLama" onkeyup="calldatagrid()">
            </div>
        </div>

        <div class="table-responsive">
            <table class="table table-hover table-sm" id="permohonan_lama">
                <thead>
